...
public class BrowserFactory {
    ...
    private static final String MESSAGE_UNKNOWN_BROWSER = "Nieznana przegladarka! Sprawdz konfiguracje!";
    ...
    private WebDriver getRemoteWebDriver(DesiredCapabilities desiredCapabilities) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("Nie udało sie utworzyć RemoteWebDrivera z powodu: " + e.getMessage());
        }
